...
@safe: /* @@@BUG@@@ workaround for bugzilla 4211 */
    ...
    int opApply(scope int delegate(ref bool)@safe dg)
    {
        int result;
    ...
    /** ditto */
    @system /* @@@BUG@@@ workaround for bugzilla 4218 */
    ...
    /** ditto */
    @safe /* @@@BUG@@@ workaround for bugzilla 4218 */
    int opApply(scope int delegate(ref size_t, ref bool)@safe dg)
    {
        int result;
    ...
    {   int i;
        ...
        if (this.length != a2.length)
            return 0;                // not equal
        const p1 = cast(const byte*)this.ptr;
        const p2 = cast(const byte*)a2.ptr;
