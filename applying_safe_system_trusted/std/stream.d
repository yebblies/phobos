...
class Stream : InputStream, OutputStream {
  ...
  @trusted /* @@@BUG@@@ workaround for bugzilla 4218 */
  int opApply(scope int delegate(ref char[] line) dg) {
    int res = 0;
    char[128] buf;
    while (!eof()) {
  ...
  @safe /* @@@BUG@@@ workaround for bugzilla 4218 */
  int opApply(scope int delegate(ref char[] line)@safe dg) {
    int res = 0;
    char[128] buf;
    while (!eof()) {
      char[] line = readLine(buf);
  ...
  @safe /* @@@BUG@@@ workaround for bugzilla 4218 */
  int opApply(scope int delegate(ref ulong n, ref char[] line)@safe dg) {
    int res = 0;
    ulong n = 1;
    char[128] buf;
    while (!eof()) {
  ...
  @safe /* @@@BUG@@@ workaround for bugzilla 4218 */
  int opApply(scope int delegate(ref wchar[] line)@safe dg) {
    int res = 0;
    wchar[128] buf;
    while (!eof()) {
      auto line = readLineW(buf);
  ...
  // iterate through the stream line-by-line with line count and wchar[]
  @safe /* @@@BUG@@@ workaround for bugzilla 4218 */
  int opApply(scope int delegate(ref ulong n, ref wchar[] line)@safe dg) {
    int res = 0;
    ulong n = 1;
    wchar[128] buf;
    while (!eof()) {
