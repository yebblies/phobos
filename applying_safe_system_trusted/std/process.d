...
/**
   ...
   ----
*/
version (Posix) @trusted string shell(string cmd)
{
    File f;
    f.popen(cmd, "r");
    char[] line;
...
version (Windows) @trusted string shell(string cmd)
{
...
version(Posix) @trusted void setenv(in char[] name, in char[] value, bool overwrite)
{
    errnoEnforce(
...
version(Posix) @trusted void unsetenv(in char[] name)
{
